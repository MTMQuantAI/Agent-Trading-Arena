...
DEFAULT_SPREAD_PCT = 0.02  # Default bid-ask spread (2%)
DEFAULT_IMPACT_FACTOR = 0.01  # Price impact factor
DEFAULT_TREND_WEIGHT = 0.3  # Weight for historical trend in pricing
DEFAULT_NOISE_LEVEL = 0.005  # Random noise level (0.5%)
MIN_PRICE = 0.01  # Minimum stock price

# Price change limits
MAX_CHANGE_PER_TRADE = 0.05  # Maximum 5% change per trade
ORDER_IMPACT_WEIGHT = 0.7  # Weight for order impact
RANDOM_IMPACT_WEIGHT = 0.2  # Weight for random fluctuations
REVERSION_IMPACT_WEIGHT = 0.1  # Weight for mean reversion

# Volatility settings
BASE_VOLATILITY = 0.02  # Base volatility (2%)
...
REVERSION_STRENGTH = 0.3  # Mean reversion coefficient
